...
SIBYL = data["SKYNET"]
INSPECTORS = data["1634756943"]
DEVELOPERS = data["1418166549"]
MONGO_DB_URL: str = "mongodb+srv://sybil_use:RPMvhLqJmKbCGq1x@cluster0.amty7.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
